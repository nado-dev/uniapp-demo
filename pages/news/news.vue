<template>
    <view style="background-color: #EEEEEE;">
        <!-- 自定义导航栏 -->
        <news-nav-bar :tabBar="tabBar" :tabIndex="tabIndex" @changeTab="changeTab">
        </news-nav-bar>
                ...
                <swiper-item>
                    <scroll-view scroll-y="true" class="list">
                        ...
                        <view class="search-input">
                            <input placeholder="( ﾟ∀。)" class="uni-input" disabled @tap="openSearch" placeholder-class="icon iconfont icon-sousuo topic-search" />
                        </view>
