        ...
        <view class="common-list-r">
            ...
            <view>
                ...
                <view class="u-f-ac u-f-jsb">
                    ...
                    <!-- 右一右边 关注按钮-->
                    <view v-if="!item.isFollow" class="icon iconfont icon-zengjia" @tap="follow()">关注</view>
                    <view v-else>已关注</view>
                </view>
                <!-- 右侧第二层 时间 -->
                <view class="common-list-r-time" v-show="item.createTime"></view>
            </view>
            ...
            <view class="u-f-ajc" style="flex-direction: column;">
                ...
                <block v-for="(pic , index) in item.morePic" :key="index">
                    <image v-if="item.PicTextStyle" :src="pic" mode="widthFix" lazy-load @tap="imgdetail(index) " style="margin-bottom:15upx ;"></image>
                </block>
                <!-- 视频 -->
