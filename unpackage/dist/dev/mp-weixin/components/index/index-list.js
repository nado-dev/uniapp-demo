...
/* harmony import */ var _index_list_vue_vue_type_template_id_7dea0143_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-list.vue?vue&type=template&id=7dea0143&scoped=true& */ 195);
/* harmony import */ var _index_list_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index-list.vue?vue&type=script&lang=js& */ 197);
...
/* harmony import */ var _index_list_vue_vue_type_style_index_0_id_7dea0143_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-list.vue?vue&type=style&index=0&id=7dea0143&scoped=true&lang=css& */ 199);
...
var _default =
{
  ...
  methods: {
    ...
    likeOpration: function () {var _likeOpration = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(likeStat) {var index, _ref3, _ref4, err, res, resdata;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                ...
                index = likeStat === 'like' ? 1 : 2; // 操作后的状态
                if (!(this.item.likeInfo.index === index)) {_context2.next = 4;break;}return _context2.abrupt("return");case 4:_context2.next = 6;return (
                ...
                this.$emit('changeevent', resdata);
                // 通知全局
                uni.$emit("updateData", resdata);case 16:case "end":return _context2.stop();}}}, _callee2, this);}));function likeOpration(_x) {return _likeOpration.apply(this, arguments);}return likeOpration;}(),
