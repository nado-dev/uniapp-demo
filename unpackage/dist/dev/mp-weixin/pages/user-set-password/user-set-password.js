...
var _userSetPassword = _interopRequireDefault(__webpack_require__(/*! ./pages/user-set-password/user-set-password.vue */ 110));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _user_set_password_vue_vue_type_template_id_9a8512ec___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user-set-password.vue?vue&type=template&id=9a8512ec& */ 111);
/* harmony import */ var _user_set_password_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./user-set-password.vue?vue&type=script&lang=js& */ 113);
...
/* harmony import */ var _user_set_password_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user-set-password.vue?vue&type=style&index=0&lang=css& */ 115);
...
var _default =
{
  ...
  methods: {
    ...
    submit: function () {var _submit = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _ref, _ref2, err, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                this.$http.errorCheck(err, res)) {_context.next = 15;break;}
                this.loading = this.disable = false;return _context.abrupt("return");case 15:


                // 修改状态，缓存
                this.User.userinfo.password = true;
                uni.setStorageSync('userinfo', this.User.userinfo);
                this.loading = this.disable = false;return _context.abrupt("return",
                uni.showToast({
                  title: '修改密码成功！',
                  success: function success() {
                    uni.navigateBack({ delta: 1 });
                  } }));case 20:case "end":return _context.stop();}}}, _callee, this);}));function submit() {return _submit.apply(this, arguments);}return submit;}(),
