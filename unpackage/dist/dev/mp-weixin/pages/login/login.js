...
var _login = _interopRequireDefault(__webpack_require__(/*! ./pages/login/login.vue */ 150));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _login_vue_vue_type_template_id_47422b4c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=47422b4c& */ 151);
/* harmony import */ var _login_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.vue?vue&type=script&lang=js& */ 153);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _login_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _login_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _login_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.vue?vue&type=style&index=0&lang=css& */ 155);
...

{
  ...
  methods: {
    ...
    submit: function () {var _submit = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!

                this.isLoginById) {_context.next = 5;break;}
                console.log("login: id:" + this.userName + " pw:" + this.pw);return _context.abrupt("return",
                this.User.login({
                  url: "user/login",
                  data: {
                    username: this.userName,
                    password: this.pw } }));case 5:




                // 手机验证
                console.log("login: phonenum:" + this.phoneNum + " verify code:" + this.vericode);return _context.abrupt("return",
                this.User.login({
                  url: "user/phonelogin",
                  data: {
                    phone: this.phoneNum,
                    code: this.vericode } }));case 7:case "end":return _context.stop();}}}, _callee, this);}));function submit() {return _submit.apply(this, arguments);}return submit;}(),
    ...
    //获取验证码
    getVericode: function () {var _getVericode = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var _this = this;var _ref, _ref2, err, res, timer;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                this.vericodeAble = false;if (!(
                this.countDown > 0)) {_context2.next = 5;break;}return _context2.abrupt("return");case 5:if (




                this.isPhoneNumVaild(this.phoneNum)) {_context2.next = 9;break;}
                uni.showToast({
                  title: "请检查手机号码格式！",
                  icon: "none" });

                this.vericodeAble = true;return _context2.abrupt("return");case 9:_context2.next = 11;return (



                  this.$http.post('user/sendcode', {
                    phone: this.phoneNum }));case 11:_ref = _context2.sent;_ref2 = _slicedToArray(_ref, 2);err = _ref2[0];res = _ref2[1];

                // 请求失败
                this.$http.errorCheck(err, res);if (!(
                res.data.errCode === 30001)) {_context2.next = 19;break;}
                uni.showToast({
                  title: "操作过于频繁，请稍后再试",
                  icon: "none" });return _context2.abrupt("return");case 19:
                ...
                }, 1000);case 22:case "end":return _context2.stop();}}}, _callee2, this);}));function getVericode() {return _getVericode.apply(this, arguments);}return getVericode;}() },
