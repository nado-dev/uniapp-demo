...
var _userChat = _interopRequireDefault(__webpack_require__(/*! ./pages/user-chat/user-chat.vue */ 87));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _user_chat_vue_vue_type_template_id_693c646e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user-chat.vue?vue&type=template&id=693c646e& */ 88);
/* harmony import */ var _user_chat_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./user-chat.vue?vue&type=script&lang=js& */ 90);
...

{
  ...
  methods: {
    ...
    //func2滚动条置于底部
    pageToButtom: function pageToButtom() {var _this = this;var isfirst = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      ...
      this.$nextTick(function () {
        ...
        function (data) {
          if (data) {
            ...
            {
              // last element
              _this.style.itemH += data[data.height - 1];
            }
            _this.style.itemH += data.height;
